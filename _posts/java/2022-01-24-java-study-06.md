...
-------------
### 상속과 코드 재사용
> 객체지향 프로그래밍의 장점 중 하나는 코드를 재사용하기 용하다는 점입니다.
...
##### DRY 원칙
> **Don't Repeat Yourself**의 약자로, 신뢰할 수 있고 수정하기 쉬운 소프트웨어를 만들기 위해 중복을 제거하는 방법입니다.
...
이처럼 상속 관계로 연결된 자식 클래스가 부모 클래스의 변경에 취약해지는 현상을 가리켜 *취약한 기반 클래스 문제*라고 합니다.
